//
//  CodeBasedSettingsViewController.swift
//  SeSACShoppingApp
//
...
class CodeBasedSettingsViewController: BaseViewController {
...
extension CodeBasedSettingsViewController: UITableViewDelegate, UITableViewDataSource {
